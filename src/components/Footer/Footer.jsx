  ...
  return (
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.footerContainer}>
        {/* 劇団名グループ（左揃え） */}
        <div className={styles.footerCompanyGroup}>
          {/* 劇団名（日本語、大きく表示） */}
          <h2 className={styles.footerCompanyName}>劇團 或素翔鷺</h2>
          
          {/* ローマ字表記（劇団名の下に配置、ふりがなのように表示） */}
          <p className={styles.footerCompanyNameRoman}>Gekidan Alstro</p>
        </div>
        ...
        <div className={styles.footerSns}>
          ...
          */}
          <a 
            ...
            className={styles.footerSnsLink}
